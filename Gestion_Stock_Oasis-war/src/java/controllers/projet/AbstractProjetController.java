...
public class AbstractProjetController {
    ...
    /*  37 */    protected Boolean detail = (true);
    /*  38 */    protected Boolean modifier = (true);
    /*  39 */    protected Boolean consulter = (true);
    /*  40 */    protected Boolean imprimer = (true);
    /*  41 */    protected Boolean supprimer = (true);
    ...
    public List<Magasin> getMagasins() {
        /* 118 */ this.magasins = this.magasinFacadeLocal.findAllRange(SessionMBean.getMagasin().getParametrage().getId());
