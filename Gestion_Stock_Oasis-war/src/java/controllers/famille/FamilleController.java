    ...
    public void create() {
        try {
            if (this.mode.equals("Create")) {
                ...
                this.famille.setDateEnregistre(new Date(System.currentTimeMillis()));
                this.famille.setDerniereModif(new Date(System.currentTimeMillis()));
                this.famille.setParametrage(SessionMBean.getMagasin().getParametrage());
